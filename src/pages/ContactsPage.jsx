    ...
    <div>
      ...
      <section className="contacts">
        ...
        <div className="contact-item">
            ...
            <p><a href="mailto:alamusiunail2023@gmail.com">alamusiunail2023@gmail.com</a></p>
        </div>

        <div className="contact-item">
            <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" fill="#57402c" className="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <p><a href="https://www.instagram.com/u_nail_2023/">@u_nail_2023</a></p>
        </div>
        </section>
